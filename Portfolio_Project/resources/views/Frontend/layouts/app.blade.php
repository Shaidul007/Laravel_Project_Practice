...
<head>
    ...
    <!-- Page Title -->
    <title>Shaidul - Personal Portfolio</title>
    <!-- Favicon Icon -->
    <link rel="icon" href="  {{ asset('forntend/assets/img') }}/favicon.png" />
    <!-- Stylesheets -->
    ...
    <link rel="stylesheet" href="  {{ asset('forntend/assets/css') }}/slick.css" />
    <link rel="stylesheet" href="  {{ asset('forntend/assets/css') }}/lightgallery.min.css" />
    <link rel="stylesheet" href="  {{ asset('forntend/assets/css') }}/animate.css" />
...
<body id="home">
                ...
                <div class="st-main-header-in">
                    <div class="st-main-header-left">
                        <a class="st-site-branding" href="index.html"><img
                                src="  {{ asset('forntend/assets/img') }}/logo.png" alt="Davis"></a>
                    </div>
                    <div class="st-main-header-right">
                        <div class="st-nav">
                            ...
                            <div class="sp-phone">
                                ...
                                <div class="sp-phone-no"><a href="callto:01721413821">01721413821</a></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="st-hero-wrap st-parallax">
        ...
        <div class="st-hero-img st-to-right">
            <img class="wow fadeInRight" src="  {{ asset('forntend/assets/img') }}/section/hero-img.png" alt="Hero">
                ...
                <div class="col-lg-6 wow fadeInLeft">
                    <div class="st-about-img-wrap">
                        <div class="st-about-img st-dynamic-bg st-bg"
                            data-src="  {{ asset('forntend/assets/img') }}/section/about.jpg"></div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="st-iconbox st-style1">
                        ...
                        <h2 class="st-iconbox-title">Web Design</h2>
                        <div class="st-iconbox-text">Our web development services focus on creating customized &
                            professional websites that meet your unique business needs. We utilize the latest web
                            technologies and design trends to create visually appealing and user-friendly websites that
                            drive engagement and conversions. Our team of experienced developers works closely with you
                            to understand your goals and deliver tailored solutions.</div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                 ...
                 c9.496,3.32,24,13.776,24,46.4V398.832z" />
                        ...
                        <div class="st-iconbox-text">Our expert designers craft visually stunning and intuitive user
                            interfaces that meet the needs of today's consumers. Using the latest design tools and
                            techniques, we create engaging designs that enhance user experience and drive business
                            growth. Contact us today to learn how we can help take your digital products to the next
                            level.</div>
                    </div>
                    <div class="st-height-b30 st-height-lg-b30"></div>
                </div><!-- .col -->
                <div class="col-lg-4 col-md-6">
                    <div class="st-iconbox st-style1">
                        ...
                        <h2 class="st-iconbox-title">Graphic Design</h2>
                        <div class="st-iconbox-text">Our expert designers craft visually stunning and intuitive user
                            interfaces that meet the needs of today's consumers. Using the latest design tools and
                            techniques, we create engaging designs that enhance user experience and drive business
                            growth. Thane softwares we use are Adobe Illustrator & Adobe Photoshop .Contact us today to
                            learn how we can help take your digital products to the next level.</div>
                    </div>
                    <div class="st-height-b30 st-height-lg-b30"></div>
                </div><!-- .col -->
                <div class="col-lg-4 col-md-6">
                    <div class="st-iconbox st-style1">
                        ...
                        <h2 class="st-iconbox-title">Video Editing</h2>
                        <div class="st-iconbox-text">Our video editing services are designed to create visually
                            compelling and engaging videos that effectively convey your brand message. Our team of
                            experienced designers and editors use the latest tools and techniques to produce
                            high-quality videos that captivate your audience. Contact us today to learn more about how
                            our services can help bring your vision to life.</div>
                    </div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                </div><!-- .col -->
                <div class="col-lg-4 col-md-6">
                    <div class="st-iconbox st-style1">
                        ...
                        <div class="st-iconbox-text">Our motion graphic services are designed to create visually
                            compelling and engaging videos that effectively convey your brand message. Our team of
                            experienced designers and editors use the latest tools and techniques to produce
                            high-quality videos that captivate your audience. Contact us today to learn more about how
                            our services can help bring your vision to life.</div>
    ...
    <div class="container">
      <div class="st-section-heading st-style1">
        <h4 class="st-section-heading-title">PRICING</h4>
        <h2 class="st-section-heading-subtitle">PRICING</h2>
      </div>
      <div class="st-height-b25 st-height-lg-b25"></div>
    </div>
      <div class="plan_main">
        <div class="row">
          <div class="col-lg-4 col-md-6 ">
            <div data-aos="fade-up" class="single-Plans">
              <div class="Plans-text">
                <i class="fas fa-briefcase"></i>
                <h4>Essential</h4>
                <p><i class="fas fa-dollar-sign"></i>129</p>
                <ul>
                  <li class="d-flex flex-wrap justify-content-between align-items-center text-left">
                    <h5>Air Brush </h5> <i class="text-right far fa-check-circle"></i>
                  </li>
                  <li class="d-flex flex-wrap justify-content-between align-items-center text-left">
                    <h5>Retouch</h5><i class="text-right far fa-check-circle"></i>
                  </li>
                  <li class="d-flex flex-wrap justify-content-between align-items-center text-left">
                    <h5>Hairstyling</h5><i class="text-right far fa-check-circle"></i>
                  </li>
                  <li class="d-flex flex-wrap justify-content-between align-items-center text-left">
                    <h5>Corner Lashes </h5><i class="text-right far fa-times-circle"></i>
                  </li>
                  <li class="d-flex flex-wrap justify-content-between align-items-center text-left">
                    <h5>Body Glowing</h5><i class="text-right far fa-times-circle"></i>
                  </li>
                  <li class="d-flex flex-wrap justify-content-between align-items-center text-left">
                    <h5>Eyebrows</h5><i class="text-right far fa-times-circle"></i>
                  </li>
                </ul>
                <a class="mx-auto" href="#"><i class=" icon1 far fa-arrow-alt-circle-right"></i>CHOSE PLAN</a>
          ...
          <div class="col-lg-4 col-md-6 ">
            <div data-aos="fade-up" class="single-Plans">
              <div class="Plans-text">
                ...
                <h4>Standard</h4>
                <p><i class="fas fa-dollar-sign"></i>199</p>
                <ul>
                  <li class="d-flex flex-wrap justify-content-between align-items-center text-left">
                    <h5>Air Brush</h5> <i class="text-right far fa-check-circle"></i>
                  </li>
                  ...
                  <li class="d-flex flex-wrap justify-content-between align-items-center text-left">
                    <h5>Corner Lashes</h5><i class="text-right far fa-check-circle"></i>
                  </li>
                  <li class="d-flex flex-wrap justify-content-between align-items-center text-left">
                    <h5>Body Glowing</h5><i class="text-right far fa-times-circle"></i>
                  </li>
                ...
                <a class="mx-auto" href="#"><i class="far fa-arrow-alt-circle-right"></i>CHOSE PLAN</a>
                <div class="circles-wrap">
                  <div class="circles">
                    <span class="circle circle-1"></span>
                    <span class="circle circle-2"></span>
          ...
          <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3 mrgn">
            <div data-aos="fade-up" class="single-Plans">
              <div class="Plans-text">
                ...
                <ul>
                  ...
                  <li class="d-flex flex-wrap justify-content-between align-items-center text-left">
                    <h5>Body Glowing</h5><i class="text-right far fa-check-circle"></i>
                  </li>
                  <li class="d-flex flex-wrap justify-content-between align-items-center text-left">
                    <h5>Eyebrows</h5><i class="text-right far fa-check-circle"></i>
                  </li>
                </ul>
                <a class="mx-auto" href="#"><i class="far fa-arrow-alt-circle-right"></i>CHOSE PLAN</a>
                <div class="circles-wrap">
      ...
      <div class="col-lg-12 text-center">
        <div class="st-portfolio-btn p-btn">
          <a href="#" class="st-btn st-style1 st-color1">View More</a>
        </div>
      </div>
    </div>
  </section> -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="st-resume-wrap">
                        <div class="st-resume-heading">
                            <img src="  {{ asset('forntend/assets/img') }}/icon/resume-icon1.png" alt="resume-icon">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="st-resume-wrap">
                        <div class="st-resume-heading">
                            <img src="  {{ asset('forntend/assets/img') }}/icon/resume-icon2.png" alt="resume-icon">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="st-portfolio-single st-style1 st-lightgallery">
                        <div class="st-portfolio-item">
                            <a href="  {{ asset('forntend/assets/img') }}/portfolio/portfolio1_lg.jpg"
                                class="st-portfolio st-zoom st-lightbox-item">
                                <div class="st-portfolio-img st-zoom-in">
                                    <img src="  {{ asset('forntend/assets/img') }}/portfolio/portfolio1.jpg"
                                        alt="portfolio">
                                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="st-portfolio-single st-style1 st-lightgallery">
                        <div class="st-portfolio-item">
                            <a href="  {{ asset('forntend/assets/img') }}/portfolio/portfolio2_lg.jpg"
                                class="st-portfolio st-zoom st-lightbox-item">
                                <div class="st-portfolio-img st-zoom-in">
                                    <img src="  {{ asset('forntend/assets/img') }}/portfolio/portfolio2.jpg"
                                        alt="portfolio">
                                </div>
                                <div class="st-portfolio-item-hover">
                                    <i class="fas fa-plus-circle"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="st-portfolio-single st-style1 st-lightgallery">
                        <div class="st-portfolio-item">
                            <a href="  {{ asset('forntend/assets/img') }}/portfolio/portfolio3_lg.jpg"
                                class="st-portfolio st-zoom st-lightbox-item">
                                <div class="st-portfolio-img st-zoom-in">
                                    <img src="  {{ asset('forntend/assets/img') }}/portfolio/portfolio3.jpg"
                                        alt="portfolio">
                                </div>
                                <div class="st-portfolio-item-hover">
                                    <i class="fas fa-plus-circle"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="st-portfolio-single st-style1 st-lightgallery">
                        <div class="st-portfolio-item">
                            <a href="  {{ asset('forntend/assets/img') }}/portfolio/portfolio4_lg.jpg"
                                class="st-portfolio st-zoom st-lightbox-item">
                                <div class="st-portfolio-img st-zoom-in">
                                    <img src="  {{ asset('forntend/assets/img') }}/portfolio/portfolio4.jpg"
                                        alt="portfolio">
                                </div>
                                <div class="st-portfolio-item-hover">
                                    <i class="fas fa-plus-circle"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="st-portfolio-single st-style1 st-lightgallery">
                        <div class="st-portfolio-item">
                            <a href="  {{ asset('forntend/assets/img') }}/portfolio/portfolio5_lg.jpg"
                                class="st-portfolio st-zoom st-lightbox-item">
                                <div class="st-portfolio-img st-zoom-in">
                                    <img src="  {{ asset('forntend/assets/img') }}/portfolio/portfolio5.jpg"
                                        alt="portfolio">
                                </div>
                                <div class="st-portfolio-item-hover">
                                    <i class="fas fa-plus-circle"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="st-portfolio-single st-style1 st-lightgallery">
                        <div class="st-portfolio-item">
                            <a href="  {{ asset('forntend/assets/img') }}/portfolio/portfolio6_lg.jpg"
                                class="st-portfolio st-zoom st-lightbox-item">
                                <div class="st-portfolio-img st-zoom-in">
                                    <img src="  {{ asset('forntend/assets/img') }}/portfolio/portfolio6.jpg"
                                        alt="portfolio">
                                </div>
                                <div class="st-portfolio-item-hover">
                                    <i class="fas fa-plus-circle"></i>
                    ...
                    <div class="slick-wrapper">
                        ...
                        <div class="slick-slide-in">
                            <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s"
                                ...
                                <div class="st-testimonial-text">
                                    <p>“5 Stars! Excellent gambling responsive mobile friendly template. I recommend to
                                        all. Excellent support with the product, fast response times and overall a
                                        pleasant experience here.”</p>
                                    <div class="st-quote"><img src="  {{ asset('forntend/assets/img') }}/icon/quote.png"
                                            alt="quote"></div>
                                </div>
                                <div class="st-testimonial-info">
                                    <div class="st-testimonial-img"><img
                                            src="  {{ asset('forntend/assets/img') }}/client/client1.png" alt="client1">
                                    </div>
                                    <div class="st-testimonial-meta">
                                        <h4 class="st-testimonial-name">Nicholas sitko</h4>
                        ...
                        <div class="slick-slide-in">
                            <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s"
                                data-wow-delay="0.2s">
                                <div class="st-testimonial-text">
                                    <p>“Very quick and detailed job done! would recommend!.”</p>
                                    <div class="st-quote"><img src="  {{ asset('forntend/assets/img') }}/icon/quote.png"
                                            alt="quote"></div>
                                </div>
                                <div class="st-testimonial-info">
                                    <div class="st-testimonial-img"><img
                                            src="  {{ asset('forntend/assets/img') }}/client/client2.png" alt="client2">
                                    </div>
                                    <div class="st-testimonial-meta">
                                        <h4 class="st-testimonial-name">Aliceperry172</h4>
                                        <div class="st-testimonial-designation">Fiverr</div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- .slick-slide-in -->
                        ...
                        <div class="slick-slide-in">
                            <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s"
                                ...
                                <div class="st-testimonial-info">
                                    <div class="st-testimonial-img"><img
                                            src="  {{ asset('forntend/assets/img') }}/client/client3.png" alt="client3">
                                    </div>
                                    <div class="st-testimonial-meta">
                                        <h4 class="st-testimonial-name">Joseph Alves</h4>
                                        <div class="st-testimonial-designation">TemplateMonster</div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- .slick-slide-in -->
                        ...
                        <div class="slick-slide-in">
                            <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s"
                                data-wow-delay="0.2s">
                                <div class="st-testimonial-text">
                                    <p>“Great work. Outstanding experience. Thank you!”</p>
                                    <div class="st-quote"><img src="  {{ asset('forntend/assets/img') }}/icon/quote.png"
                                            alt="quote"></div>
                                </div>
                                <div class="st-testimonial-info">
                                    ...
                                    <div class="st-testimonial-meta">
                                        <h4 class="st-testimonial-name">Grimesds Miles</h4>
                                        <div class="st-testimonial-designation">Fiverr</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="slick-container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
                    ...
                    <div class="slick-wrapper">
                        <div class="slick-slide-in">
                            <div class="st-post-single st-style1">
                                <a href="blog-details.html" class="st-post-thumb st-zoom">
                                    <img src="  {{ asset('forntend/assets/img') }}/blog/blog1.jpg" class="st-zoom-in"
                                        alt="blog1">
                                </a>
                                <div class="st-post-info">
                                    <div class="st-post-date">
                                        ...
                                        <span class="st-post-publish-date">15-04-2023</span>
                                    </div>
                        ...
                        <div class="slick-slide-in">
                            <div class="st-post-single st-style1">
                                <a href="blog-details.html" class="st-post-thumb st-zoom">
                                    <img src="  {{ asset('forntend/assets/img') }}/blog/blog2.jpg" class="st-zoom-in"
                                        alt="blog2">
                                </a>
                                <div class="st-post-info">
                                    <div class="st-post-date">
                        ...
                        <div class="slick-slide-in">
                            <div class="st-post-single st-style1">
                                <a href="blog-details.html" class="st-post-thumb st-zoom">
                                    <img src="  {{ asset('forntend/assets/img') }}/blog/blog3.jpg" class="st-zoom-in"
                                        alt="blog3">
                                </a>
                                <div class="st-post-info">
                                    <div class="st-post-date">
                    ...
                    <div class="st-contact-info-wrap">
                        ...
                        <div class="st-social-info">
                            ...
                            <div class="st-social-link">
                                ...
                                <a href="https://www.linkedin.com/in/shaidul-islam-rony-454a961b1/"
                                    class="st-social-btn">
                                    <span class="st-social-icon"><i class="fab fa-linkedin"></i></span>
                                    <span class="st-icon-name">LinkedIn</span>
                                </a>
    ...
    <div class="btn_top_bottom">
        ...
        <p style="font-size: 30px; text-align: center; margin-top: 6px;">↑</p>
    </div>
    <!-- **************************************
                  btn_top_bottom part end
           **************************************-->
    <!-- Scripts -->
    <script src="  {{ asset('forntend/assets/js') }}/jquery-1.12.4.min.js"></script>
    <script src="  {{ asset('forntend/assets/js') }}/jquery.slick.min.js"></script>
    <script src="  {{ asset('forntend/assets/js') }}/lightgallery.min.js"></script>
    <script src="  {{ asset('forntend/assets/js') }}/wow.min.js"></script>
    <script src="  {{ asset('forntend/assets/js') }}/ripples.min.js"></script>
    <script src="  {{ asset('forntend/assets/js') }}/particles.min.js"></script>
